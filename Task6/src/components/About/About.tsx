      ...
      <div className='pb-4 my-4 border-b-2'>
        ...
        <div className='flex items-center my-3.5'>
          ...
          <div className='mx-1'>
            ...
            <h3 className='text-sm text-slate-900'>{data.about.posted_on}</h3>
          </div>
        </div>
        <div className='flex items-center my-3.5'>
          <svg
          ...
          <div className='mx-1'>
            ...
            <h3 className='text-sm text-slate-900'>{data.about.deadline}</h3>
          </div>
        </div>
        <div className='flex items-center my-3.5'>
          <svg
          ...
          <div className='mx-1'>
            ...
            <h3 className='text-sm text-slate-900'>{data.about.location}</h3>
          </div>
        </div>
        <div className='flex items-center my-3.5'>
          <svg
          ...
          <div className='mx-1'>
            ...
            <h3 className='text-sm text-slate-900'>{data.about.start_date}</h3>
          </div>
        </div>
        ...
        <div className='flex items-center my-3.5'>
          ...
          <div className='mx-1'>
            ...
            <h3 className='text-sm text-slate-900'>{data.about.end_date}</h3>
          </div>
        </div>
      </div>
      <div className='pb-4 my-4 border-b-2'>
        <h1 className='my-3'>Category</h1>
        {data.about.categories.map((ele, index) => (
          <Button key={index} background={'bg-slate-50'} border={''} text={'text-slate-800'} value={ele} />
        ))}
      </div>
      <div className='my-5 '>
        <h1>Required Skill</h1>
        <div className='min-h-40 max-w-56'>
          {data.about.required_skills.map((ele, index) => (
