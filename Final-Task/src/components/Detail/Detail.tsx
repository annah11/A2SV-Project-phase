...
export default function Detail({ data }: { data: JobPost }) {
  return (
    <div className="flex-shrink max-w-3xl my-10">
      ...
      <div className="my-3">
        <h1 className="mb-3 font-bold text-2xl">Responsibility</h1>
        <ul>
          {data
      ...
      <div className="my-3">
        <h1 className="font-extrabold text-xl my-5">Ideal Candidate we want</h1>
        <ul>{data.idealCandidate || "NOT PROVIDED"}</ul>
      </div>
      <div className="my-5">
        <h1 className="font-extrabold text-xl w-[240px] mb-5">When & Where</h1>
        <svg
          width="45"
          height="44"
          viewBox="0 0 45 44"
        ...
        <h3 className="inline-block text-slate-800">
          {data.whenAndWhere || "NOT PROVIDED"}
        </h3>
      </div>
    </div>
  );
